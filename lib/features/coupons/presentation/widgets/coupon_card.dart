      ...
      child: Column(
        ...
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              customCouponPrimaryTitle('25 Coupon Bundle', screenWidth, screenHeight),
          ...
          Row(
            children: [
              ...
              Text('Purchased On March 24, 2025',style: TextStyle(fontWeight: FontWeight.w400,fontSize: screenWidth*.036),),
            ],
          ),
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                BuildNetworkOrderImage(screenWidth, screenHeight, imageUrl,'assets/images/home/main_page/company.png'),
          ...
          Padding(
            ...
            child: LinearProgressIndicator(
              value: 0.4, // Represents 70% progress
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              ...
              customCouponSecondaryTitle('10 Remaining', screenWidth, screenHeight)
            ],),
          Padding(
           ...
           Flexible(
              child: Padding(
                ...
                child: Text('Automatically Purchase New Coupons When This Bundle Runs Out',
                  style: TextStyle(fontWeight: FontWeight.w400,fontSize: screenWidth*.036),),
              ),

          ),
          Text('Delivery Address',style: TextStyle(fontWeight: FontWeight.w600,fontSize: screenWidth*.036),),
          Text(
            'Zone abc, Street 20, Building 21, Flat 22',
            style: TextStyle(fontWeight: FontWeight.w500,fontSize: screenWidth*.032,
                color: AppColors.BorderAnddividerAndIconColor),
          ),
          SizedBox(height: screenHeight*.03,),
          customCouponPrimaryTitle('Weekly Sent Bundles', screenWidth, screenHeight),
                        ...
                        children: [
                          Expanded(
                            child: LabledBuildRoundedIconOnProduct(
                                ...
                                fromDetailedScreen: true, title: 'Days',
                               ),
                          ),
                        ],
          ...
          customCouponPrimaryTitle('Bottles For Once', screenWidth, screenHeight),
                        ...
                        children: [
                          Expanded(
                            child: LabledBuildRoundedIconOnProduct(
                              ...
                              onTextfieldChanged: (value) => context.read<ProductQuantityBloc>().add(QuantityChanged(value)),
                              onDone: () => context.read<ProductQuantityBloc>().add(QuantityEditingComplete()),
                              fromDetailedScreen: true, title: 'Bottles',
                            ),
                          ),
                        ],
        ...
        BuildInfoAndAddToCartButton(screenWidth, screenHeight, 'View Consumption History', false, (){},fromCouponsScreen: true)
