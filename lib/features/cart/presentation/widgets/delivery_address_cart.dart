...
Widget OrderDeliveryCartWidget(BuildContext context,double screenWidth, double screenHeight) {
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            BuildCardAddress(context, screenHeight, screenWidth,fromCart:true),
            BuildCardAddress(context, screenHeight, screenWidth,work: true,fromCart:true),
